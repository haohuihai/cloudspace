...
##! 向外暴露一个地址  这个是我们访问私有gitlab仓库的地址 不用写端口号  
##! 下面的设置 重新修改完 执行 gitlab-ctl reconfigure 来重新配置gitlab
external_url 'http://101.132.124.188'
...
################################################################################
gitlab_rails['gitlab_ssh_host'] = '101.132.124.188'
## gitlab_rails['time_zone'] = 'UTC'

### Email Settings
gitlab_rails['gitlab_email_enabled'] = true
gitlab_rails['gitlab_email_from'] = '157855644@qq.com'
gitlab_rails['gitlab_email_display_name'] = 'haohuihai'
...
gitlab_rails['smtp_user_name'] = "157855644@qq.com"
gitlab_rails['smtp_password'] = "kjmlqepwgikocajj"
